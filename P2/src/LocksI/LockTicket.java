...
public class LockTicket implements Locks {
    ...
    private AtomicInteger turno = new AtomicInteger(0);  // Número de ticket del hilo que actualmente puede entrar en la sección crítica
    ...
    public void releaseLock(int id) {
        turno.incrementAndGet(); // Incrementa el turno para permitir que el siguiente hilo entre a la sección crítica
    }
}
