...
public class OyenteServidor implements Runnable {
    ...
    public OyenteServidor(Socket socketCliente, ConcurrentConsole out) {
           ...
           ccout.print("Mensaje recibido: " + mensaje.getTipo());
            ...
            switch (mensaje.getTipo()) {
                case "CONEXION":
                    ...
                    ccout.print("Equipo conectado: " + conexion.getNombreEquipo());
                    // Registrar equipo en la lista de usuarios
                    MensajeConfConexion confirmacion = new MensajeConfConexion(conexion.getNombreEquipo(),conexion.getPuntos());
