...
public class Cliente {
    ...
    public void iniciar() {
        try {
            ...
            listas = new GestionListas(datos_cliente.getNombre(),vista);
    ...
    private void opcion_descargar(){
        ...
        try {
            MensajeSolicitudDescarga lista = new MensajeSolicitudDescarga(datos_cliente.getNombre(),archivo,propietario);
    ...
    private void actualizarListasEnServidor(){
        List<String> info = listas.listasCliente();//listas.listasCliente();
        MensajeInformacionCiente informacion = new MensajeInformacionCiente(info,datos_cliente.getNombre());
        try {
